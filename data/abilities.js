...
let BattleAbilities = {
      ...
      for (const target of pokemon.side.foe.active) {
        ...
        for (const moveSlot of target.moveSlots) {
          ...
          if (
            ...
            ((this.getImmunity(moveType, pokemon) &&
              this.getEffectiveness(moveType, pokemon) > 0) ||
              move.ohko)
          ) {
  ...
  zenmode: {
    desc:
      "If this Pokemon is a Darmanitan, it changes to Zen Mode if it has 1/2 or less of its maximum HP at the end of a turn. If Darmanitan's HP is above 1/2 of its maximum HP at the end of a turn, it changes back to Standard Mode. This Ability cannot be removed or suppressed.",
    shortDesc:
